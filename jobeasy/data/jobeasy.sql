...
--
-- Host: 127.0.0.1
-- Generation Time: 02-Maio-2015 às 21:32
...
INSERT INTO `contatos` (`id`, `email`, `celular`, `telefone`, `email2`, `celular2`, `telefone2`) VALUES
(2, 'lucianoguida10@gmail.com', '6392006705', '6333613493', NULL, NULL, NULL),
(3, 'infocenter05@hotmail.com', '8588885841', '6333614578', NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `empresas` (
  ...
  `contatos_id` int(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_empresas_usuarios1_idx` (`user_id`),
  KEY `fk_empresas_enderecos1_idx` (`enderecos_id`),
  KEY `fk_empresas_contatos1_idx` (`contatos_id`)
...
INSERT INTO `empresas` (`id`, `nome`, `cnpj`, `ramo_atividade`, `user_id`, `enderecos_id`, `contatos_id`) VALUES
(1, 'Info center', '5651654984', 'Informatica', 6, 3, 3);
...
INSERT INTO `enderecos` (`id`, `rua`, `cep`, `setor`, `numero`, `cidades_id`) VALUES
(2, 'Jose nezio Ramos', '77600000', 'Alto paraiso', 949, 5518),
(3, 'Tocantins', '77600000', 'centro', 494, 5518);
...
CREATE TABLE IF NOT EXISTS `lost_passwords` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NOT NULL,
  `IP` varchar(20) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `lost_password_user_id_idx` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `pessoas` (
  ...
  `user_id` int(255) NOT NULL,
  `enderecos_id` int(11) NOT NULL,
  `curriculos_id` int(255) DEFAULT NULL,
  `contatos_id` int(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_pessoas_usuarios_idx` (`user_id`),
  KEY `fk_pessoas_enderecos1_idx` (`enderecos_id`),
  KEY `fk_pessoas_curriculos1_idx` (`curriculos_id`),
  KEY `fk_pessoas_contatos1_idx` (`contatos_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=2 ;
...
INSERT INTO `pessoas` (`id`, `full_name`, `rg`, `cpf`, `ramo_atividade`, `user_id`, `enderecos_id`, `curriculos_id`, `contatos_id`) VALUES
(1, 'Luciano Guida', '55596', '05848058105', 'Informatica', 5, 2, NULL, 2);

-- --------------------------------------------------------

--
-- Estrutura da tabela `requists`
--

CREATE TABLE IF NOT EXISTS `requists` (
  `curriculos_id` int(255) NOT NULL,
  `vagas_id` int(255) NOT NULL,
  `user_id` int(255) NOT NULL,
  `empresas_id` int(255) NOT NULL,
  PRIMARY KEY (`curriculos_id`,`vagas_id`),
  KEY `fk_curriculos_has_vagas_vagas1_idx` (`vagas_id`),
  KEY `fk_curriculos_has_vagas_curriculos1_idx` (`curriculos_id`),
  KEY `fk_solicitacoes_usuarios1_idx` (`user_id`),
  KEY `fk_solicitacoes_empresas1_idx` (`empresas_id`)
...
INSERT INTO `users` (`id`, `full_name`, `username`, `password`, `salt`, `obs`, `role`, `status`) VALUES
(5, 'Luciano Guida', 'luciano', 'd988fc953642dc536a1804b91fb4b1467290ebdf270c92d49e5fac5aeb1a1c3254830ef068cacb747ab5d9275a412d9b21fc47a3678991ffd5c05fe7f97ad4ba', '4f29b9d46029a936e0cca9b35a46c39baac00d3495972f50a1c60aa28630b831717e0fec456005908b389addf983a348885326d8cb24bd72af06314204d514d5', NULL, 'user', 1),
(6, 'Info center', 'infocenter', 'd12a5ff3453a2f43ac7f4621f9d863829c1d17cc1d55e6664cb2843c6ba8202cf343094ed6df9430cf834b63593f23d243184435650e94c003125a7733369bfa', 'c1b2c90851002759be49d3ff5259f4e188ef137b5dd43c9a35536cb42f8f6d4e077e859f6f443acc61e917fc0c4dceb8b479197e6a0e9d6bc449ed4c1cd0125f', NULL, 'empresa', 1);
...
CREATE TABLE IF NOT EXISTS `vagas` (
  ...
  `cidades_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_vagas_empresas1_idx` (`empresas_id`),
  KEY `fk_vagas_cidades1_idx` (`cidades_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
ALTER TABLE `empresas`
  ADD CONSTRAINT `fk_empresas_usuarios1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_empresas_enderecos1` FOREIGN KEY (`enderecos_id`) REFERENCES `enderecos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_empresas_contatos1` FOREIGN KEY (`contatos_id`) REFERENCES `contatos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `pessoas`
  ADD CONSTRAINT `fk_pessoas_contatos1` FOREIGN KEY (`contatos_id`) REFERENCES `contatos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pessoas_curriculos1` FOREIGN KEY (`curriculos_id`) REFERENCES `curriculos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pessoas_enderecos1` FOREIGN KEY (`enderecos_id`) REFERENCES `enderecos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_pessoas_usuarios` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `requists`
--
ALTER TABLE `requists`
  ADD CONSTRAINT `fk_curriculos_has_vagas_curriculos1` FOREIGN KEY (`curriculos_id`) REFERENCES `curriculos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_curriculos_has_vagas_vagas1` FOREIGN KEY (`vagas_id`) REFERENCES `vagas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_solicitacoes_usuarios1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_solicitacoes_empresas1` FOREIGN KEY (`empresas_id`) REFERENCES `empresas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `vagas`
--
ALTER TABLE `vagas`
  ADD CONSTRAINT `fk_vagas_empresas1` FOREIGN KEY (`empresas_id`) REFERENCES `empresas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_vagas_cidades1` FOREIGN KEY (`cidades_id`) REFERENCES `cidades` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
